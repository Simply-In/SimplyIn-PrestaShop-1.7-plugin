...
const isOrderConfirmationExecuted = sessionStorage.getItem(
  "orderConfirmationExecuted"
);

if (isOrderConfirmationExecuted === true) {
} else {
  sessionStorage.setItem("orderConfirmationExecuted", true);

  $(document).ready(async function () {
    const middlewareApiTwo = async ({
      endpoint,
      method,
      requestBody,
      token,
